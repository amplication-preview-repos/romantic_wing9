...
@InputType()
class AnalysisResultCreateNestedManyWithoutDataTablesInput {
...
export { AnalysisResultCreateNestedManyWithoutDataTablesInput as AnalysisResultCreateNestedManyWithoutDataTablesInput };
