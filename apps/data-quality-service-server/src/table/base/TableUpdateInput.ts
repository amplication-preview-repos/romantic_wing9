...
class TableUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ColumnUpdateManyWithoutTablesInput,
  })
  @ValidateNested()
  @Type(() => ColumnUpdateManyWithoutTablesInput)
  @IsOptional()
  @Field(() => ColumnUpdateManyWithoutTablesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => AnalysisResultUpdateManyWithoutTablesInput,
  })
  @ValidateNested()
  @Type(() => AnalysisResultUpdateManyWithoutTablesInput)
  @IsOptional()
  @Field(() => AnalysisResultUpdateManyWithoutTablesInput, {
    nullable: true,
  })
