...
@InputType()
class AnalysisResultCreateNestedManyWithoutRecipesInput {
...
export { AnalysisResultCreateNestedManyWithoutRecipesInput as AnalysisResultCreateNestedManyWithoutRecipesInput };
