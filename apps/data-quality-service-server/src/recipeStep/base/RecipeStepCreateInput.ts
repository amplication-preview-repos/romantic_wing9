...
class RecipeStepCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RecipeColumnsCreateNestedManyWithoutRecipeStepsInput,
  })
  @ValidateNested()
  @Type(() => RecipeColumnsCreateNestedManyWithoutRecipeStepsInput)
  @IsOptional()
  @Field(() => RecipeColumnsCreateNestedManyWithoutRecipeStepsInput, {
    nullable: true,
  })
  recipeColumnsItems?: RecipeColumnsCreateNestedManyWithoutRecipeStepsInput;
}

export { RecipeStepCreateInput as RecipeStepCreateInput };
